...
class _feedbackPageState extends State<feedbackPage> {
  ...
  List<List<String>> clothesName = [
    ...
    ['숏팬츠', '트레이닝팬츠', '슬랙스', '데님팬츠', '코튼팬츠', '여름스커트', '봄가을스커트', '레깅스', '겨울스커트'],
  ];
  double _sliderValue = 2.0;
  final List<String> _valueMap = [
    "추웠어요",
    "조금 추웠어요",
    "적당했어요",
    "조금 더웠어요",
                    ...
                    children: [
                      ...
                      ElevatedButton(
                          onPressed: () async {
                            ...
                            int outerIndex =
                                clothesName[0].indexOf(outerDropdownValue) - 1;
                            int topIndex =
                                clothesName[1].indexOf(topDropdownValue);
                            int bottomIndex =
                                clothesName[2].indexOf(bottomDropdownValue);
                            int? temperature = temp!.toInt();
                            await FirebaseFirestore.instance
                                .collection(_authentication.currentUser!.uid)
                                .doc(DateTime.fromMicrosecondsSinceEpoch(
                            ...
                            adjustConstitution(
                                ...
                                [outerIndex, topIndex, bottomIndex],
                                feedInfo.data()!['temperature'].toInt());
                            Navigator.popUntil(
